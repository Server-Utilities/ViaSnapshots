...
public class ViaManagerImpl implements ViaManager {
    ...
    public void onServerLoaded() {
        ...
        if (protocolVersion.isKnown()) {
            ...
            } else if (protocolVersion.highestSupportedVersion() <= ProtocolVersion.v1_12_2.getOriginalVersion()) {
    ...
    private void loadServerProtocol() {
        try {
            ...
            if (platform.isProxy()) {
                ...
                versionInfo = new ServerProtocolVersionSingleton(serverProtocolVersion.getOriginalVersion());
            }
